document.addEventListener("DOMContentLoaded",function(){"use strict";$('.validate-input .input100').each(function(){$(this).on('blur',function(){if(validate(this)==!1){showValidate(this)}else{$(this).parent().addClass('true-validate')}})})
